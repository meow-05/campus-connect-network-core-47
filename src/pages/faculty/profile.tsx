...
import { EditableFacultyForm } from '@/components/profile/EditableFacultyForm';
      ...
      <div className="flex items-center justify-center min-h-96">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            There was a problem loading the faculty profile.
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="flex items-center justify-center min-h-96">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            Faculty profile information is not available.
          </p>
        </div>
      </div>
    );
