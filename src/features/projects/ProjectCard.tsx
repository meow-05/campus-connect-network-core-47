      ...
      <CardContent className="flex-1 space-y-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {project.college_name && (
            <span className="text-xs text-muted-foreground">• {project.college_name}</span>
          )}
        </div>
      ...
      <CardFooter className="flex gap-2">
        <Dialog open={showViewModal} onOpenChange={setShowViewModal}>
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <ProjectViewModal project={project} onClose={() => setShowViewModal(false)} />
          </DialogContent>
        </Dialog>
        ...
        {canRequestJoin && (
          <Dialog open={showJoinModal} onOpenChange={setShowJoinModal}>
            ...
            <DialogContent className="max-w-md">
              <JoinProjectModal project={project} onClose={() => setShowJoinModal(false)} />
            </DialogContent>
          </Dialog>
        )}
      </CardFooter>
